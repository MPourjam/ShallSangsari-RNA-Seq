...
SavedData <- file.path("/media/animalscience/nikookalam/MPourjam/RProject/RNA-Seq_Oar3.1_V/SavedData") # Modified to work from HDD
...
setwd(file.path("/media/animalscience/nikookalam/MPourjam/RProject/RNA-Seq_Oar3.1_V"))
for (p in as.list(file.path(list.dirs(path = "/media/animalscience/nikookalam/MPourjam/RProject/RNA-Seq_Oar3.1_V/Results",full.names = TRUE,recursive = FALSE )))) {
...
RegionMatFilesPath <- list.files(path = "/media/animalscience/nikookalam/MPourjam/RProject/RNA-Seq_Oar3.1_V/SavedData/RegionMats", full.names = TRUE)
